...
/* We now add a mutex, which we lock at the beginning of every connection,
   and unlock at the end.  That means that connections cannot proceed in 
   parallel -- they have to serialize. */
