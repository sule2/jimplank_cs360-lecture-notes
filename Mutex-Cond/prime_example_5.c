/* prime_example_5.c - trying to put the output functionality into another thread
   James S. Plank
   April, 2017
 */
...
int main(int argc, char **argv)
{
  ...
  pthread_create(&writer_tid, NULL, writer_thread, (void *) &writer_info);
